...
import { KyNhanType, CreateKyNhanBodyType, UpdateKyNhanBodyType, QueryKyNhanType } from './entities/kynhan.entities';
...
export class KyNhanRepository {
    ...
    async findFirstDeleted(where: { id: number; deletedAt: { not: null } }): Promise<KyNhanType | null> {
