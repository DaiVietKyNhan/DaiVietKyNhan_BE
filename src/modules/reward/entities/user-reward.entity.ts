...
export const ExchangeRewardBodySchema = z
  .object({
    rewardId: z.number()
  })
  .strict()

export const RedeemCodeBodySchema = z
  .object({
...
export const USER_REWARD_FIELDS = [
  ...Object.keys(UserRewardSchema.shape),
  'reward.code'
] as UserRewardFieldType[]
