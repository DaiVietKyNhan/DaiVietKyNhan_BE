import {
  ...
  MediaResSchema,
  MediaListResSchema,
  BulkCreateMediaBodySchema,
  BulkCreateMediaResSchema
...
export class BulkCreateMediaBodyDTO extends createZodDto(BulkCreateMediaBodySchema) { }

export class BulkCreateMediaResDTO extends createZodDto(BulkCreateMediaResSchema) { }
